    ...
    <main class="layout layout--has-sidebar">
      <div class="layout__container">
        <div class="layout__wrapper">
          ...
          <section class="conversation-topic conversation-topic--mobile">
            <div class="section__container">
              <h1 class="conversation-topic__title">
                Restaurant Scenarios: Real-Life English Conversations for ESL
                Learners
              </h1>
              <p class="conversation-topic__description line-clamp-2">
              ...
              <button
                class="conversation-topic__button conversation-topic__button--read-more"
              >
                Read More
              </button>
            </div>
              ...
              <div class="chat__box">
                <div class="chat__card">
                  <div class="chat__card-header">
                    <h3 class="chat__title text-truncate">
                      role play at <span>airport</span>
                    </h3>
                  </div>
          ...
          <div class="layout__content">
            <section class="breadcrumb breadcrumb--desktop">
              <div class="breadcrumb__container section__container">
                <nav class="breadcrumb__nav" aria-label="Breadcrumb">
                  <ol class="breadcrumb__list">
                    <li class="breadcrumb__item">
                ...
                <div class="toc__sections">
                    ...
                    <ul class="toc__section-list">
                      ...
                      <li class="toc__section-item">
                        ...
                        <div class="toc__section-terms-wrapper">
                          ...
                          <p class="toc__section-definition">
                            A dish recommended by the restaurant, often not on
                            the regular menu.
                          </p>
                        </div>
                      </li>
                  ...
                  >
                    ...
                    <div class="conversation__image">
                      <img
                        src="/src/assets/img/Orderingfood-vector.png"
                        alt="learn english conversation with LingUp"
                      />
                    </div>
                    <div class="conversation__content">
                      <div class="conversation__scene">
                        <strong class="conversation__scene-label"
                          >Scene:</strong
                        >
                        <p class="conversation__scene-description">
                          You are dining at a restaurant. The waiter comes to
                          take your order.
                        </p>
                      </div>
                      ...
                      <div class="conversation__wrapper">
                        ...
                        <div class="conversation__exchange">
                          ...
                          <span class="conversation__message"
                            >Good evening! Welcome to The Green Plate. Here’s
                            the menu.</span
                          >
                        </div>
                        ...
                        <div class="conversation__exchange">
                          ...
                          >
                          <span class="conversation__message"
                            >Thank you. Can I get a few minutes to decide?</span
                          >
                        </div>
                        ...
                        <div class="conversation__exchange">
                          ...
                          >
                          <span class="conversation__message"
                            >Yes, I’d like to start with the Caesar salad and
                            then have the grilled chicken for my main
                            course.</span
                          >
                        </div>
                        ...
                        <div class="conversation__exchange">
                          ...
                          >
                          <span class="conversation__message"
                            >Great choice! Would you like anything to
                            drink?</span
                          >
                        </div>
                        ...
                        <div class="conversation__exchange">
                          ...
                          >
                          <span class="conversation__message"
                            >Sure thing. I’ll bring your order shortly.</span
                          >
                        </div>
                      </div>
                    </div>
                  ...
                  >
                    ...
                    <div class="scenario__card">
                      ...
                      <div class="scenario__content">
                        <a href="#" class="scenario__heading">Ordering Food</a>
                        <div class="scenario__details">
                          <p class="scenario__text">
                            ...
                            and vocabulary to do it confidently. This page
                    ...
                    <div class="scenario__card">
                      ...
                      <div class="scenario__content">
                        <a href="#" class="scenario__heading"
                    ...
                    <ul class="info-list__items">
                      <li>
                        <p class="info-list__text">
                          ...
                          In most English-speaking countries, tipping is
                          standard. A tip of 15–20% of the bill is common for
                          good service.
                        </p>
                      </li>
                      <li>
                        <p class="info-list__text">
                          ...
                          when speaking with restaurant staff.
                        </p>
                      </li>
                      <li>
                        <p class="info-list__text">
                  ...
                  >
                    ...
                    <p class="toc__section-description">
                      This page is designed to help you navigate common
                      restaurant scenarios in English with ease. Start by
                      practicing these dialogues and phrases, and then move on
                      to specific scenarios using the links above. With regular
                      practice, you’ll feel more confident speaking English in
                      ...
                      <form class="comments__form">
                        ...
                        <div class="comments__fields-group">
                          <div class="comments__field">
                            <div class="comments__floating-label">
                              <span
                                class="comments__addon comments__addon--name"
                              >
                              </span>
                              <input
                                class="comments__input"
